...
A bounded candidate is an Einstein--matter source--clock--archive problem in
which clock worldlines and access routes are generated by the matter flow.
Do not turn the present two-clock rank repair into another fitted sensor
campaign.
