...
| Physical compactness versus finite nonlinear passive certificate | `HC-DU-095/096` finite-reduce a selected regularity-compact class; `HC-DU-097/098` add packet and Gaussian gates. `HC-DU-099` ties calibrated equilibrium correlation to linear response. `HC-DU-100` proves that no fixed finite response jet identifies a general analytic nonlinear response map; a common analytic-tail bound gives a conditional finite-resolution bridge. The white-noise passive theorem reconstructs a typed Riemannian target, while the Lorentzian conformal theorem uses nonlinear wave interaction | Select a physical stationary arena, response-complete higher-correlation instrument, common analytic tail, target margin, mixing bound, finite detector and complete acquisition; then test no-refit causal/conformal transfer | Calling a stochastic setting or theoretical correlation a formed finite record; treating two-point FDT as the nonlinear source-to-solution map; or conflating passive Riemannian imaging with Lorentzian causal reconstruction ([HC-DU-095](../explorations/finite-target-resolution-certification-from-compact-physical-capability-surfaces-2026-07-28.md), [HC-DU-096](../explorations/physical-regularity-gap-compactness-and-geometric-target-topology-boundary-2026-07-28.md), [HC-DU-097](../explorations/quantitative-finite-probe-construction-small-ball-observability-and-sobolev-entropy-boundary-2026-07-28.md), [HC-DU-098](../explorations/stochastic-multiplexing-pairwise-uniform-observability-and-finite-energy-record-boundary-2026-07-28.md), [HC-DU-099](../explorations/fluctuation-dissipation-passive-response-reconstruction-thermal-calibration-gauge-and-finite-time-record-boundary-2026-07-28.md), [HC-DU-100](../explorations/nonlinear-fluctuation-response-hierarchy-finite-jet-obstruction-and-passive-to-active-geometry-handoff-2026-07-28.md)) |
