...
| Continuum capability surface versus finite certificate | `HC-DU-095` proves that a compact completion class and continuous physically realizable target-separating measurements have a finite subfamily with a positive uniform margin at every fixed target resolution. Boundedness alone fails, and “one experiment” can still carry an infinite source or continuum response | Derive a physically selected compact Lorentzian class in the target topology, construct a jointly executable bounded QFT-realizable separating packet, and keep complete calibrated acquisition below half its margin | Calling a bounded class compact, a one-source continuum trace finite data, or the target-dependent compactness existence proof a selected universal record ([HC-DU-095](../explorations/finite-target-resolution-certification-from-compact-physical-capability-surfaces-2026-07-28.md)) |
