...
| Physical compactness versus finite stochastic certificate | `HC-DU-095/096` finite-reduce a selected regularity-compact class; `HC-DU-097/098` add packet and Gaussian gates. `HC-DU-099` shows KMS/FDT can tie equilibrium correlations to response, but an exact thermal gauge preserves the full passive law while changing force response. Calibrated \(\beta\) repairs the OU class; finite evidence still needs uniform mixing | Select active covariances or an equilibrium state/phase, calibration, observable/coupling and detector; prove a uniform finite-time target gap and mixing bound, then bound acquisition and no-refit transfer | Calling a stochastic setting or theoretical correlation a finite record; treating FDT as a state/interface selector; or importing ideal white-noise, infinite-time, or finite-dimensional results without their premises ([HC-DU-095](../explorations/finite-target-resolution-certification-from-compact-physical-capability-surfaces-2026-07-28.md), [HC-DU-096](../explorations/physical-regularity-gap-compactness-and-geometric-target-topology-boundary-2026-07-28.md), [HC-DU-097](../explorations/quantitative-finite-probe-construction-small-ball-observability-and-sobolev-entropy-boundary-2026-07-28.md), [HC-DU-098](../explorations/stochastic-multiplexing-pairwise-uniform-observability-and-finite-energy-record-boundary-2026-07-28.md), [HC-DU-099](../explorations/fluctuation-dissipation-passive-response-reconstruction-thermal-calibration-gauge-and-finite-time-record-boundary-2026-07-28.md)) |
