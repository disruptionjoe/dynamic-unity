...
| Physical compactness versus finite stochastic certificate | `HC-DU-095/096` finite-reduce a physically selected regularity-compact class. `HC-DU-097` shows compactness alone gives no packet count or margin. `HC-DU-098` proves a Gaussian source/readout law supplies an explicit small-ball modulus only when the noise-weighted response has a uniform Hilbert--Schmidt gap. Pairwise almost-sure separation is not uniform reconstruction; full isotropy conflicts with finite energy in infinite dimension; published one-white-noise results retain distribution-valued traces and infinite-time correlation limits | Select finite-energy source/readout covariances, prove the finite-time gap \(s_\delta>0\), then bound source, detector, duration, bandwidth, repetitions, quantization, complete acquisition and no-refit transfer | Calling one stochastic setting one finite record, commuting pairwise and uniform probability-one quantifiers, treating ideal white noise as bounded energy, or importing finite-dimensional inverse results without a physical law selecting the model class ([HC-DU-095](../explorations/finite-target-resolution-certification-from-compact-physical-capability-surfaces-2026-07-28.md), [HC-DU-096](../explorations/physical-regularity-gap-compactness-and-geometric-target-topology-boundary-2026-07-28.md), [HC-DU-097](../explorations/quantitative-finite-probe-construction-small-ball-observability-and-sobolev-entropy-boundary-2026-07-28.md), [HC-DU-098](../explorations/stochastic-multiplexing-pairwise-uniform-observability-and-finite-energy-record-boundary-2026-07-28.md)) |
