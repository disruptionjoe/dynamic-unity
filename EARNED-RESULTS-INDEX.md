---
title: "Dynamic Unity — Earned Results Index through 2026-07-27"
status: historical_snapshot
doc_type: historical_results_index
created: 2026-07-25
revised: 2026-07-27
snapshot_closed: 2026-07-27
current_routing_authority: CURRENT-RESEARCH.yaml
---

# Earned Results Index through 2026-07-27

> Historical results snapshot. This file preserves the accumulated scientific
> orientation that existed when the current-research authority was migrated.
> It is evidence context, not current work routing. Read
> [`CURRENT-RESEARCH.yaml`](CURRENT-RESEARCH.yaml) for active, prepared, parked,
> blocked, next-action, stop, and reopen state.
